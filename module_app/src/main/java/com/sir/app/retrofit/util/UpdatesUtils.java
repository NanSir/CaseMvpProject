...
import com.sir.app.retrofit.common.UpdateInfo;
import com.sir.app.retrofit.net.download.DownLoadService;
import com.sir.app.retrofit.net.download.DownloadInfo;
...
public class UpdatesUtils {
    ...
    private DownloadInfo setUpdate(UpdateInfo apk) {
        ...
        loadingBean.setLogo(R.mipmap.ic_logo);
