...
public class Colorful {
    ...
    public static void init(Context context) {
        themeString = PreferenceManager.getDefaultSharedPreferences(context).getString("colorful_pref_key", null);
        if (themeString == null) {
    ...
    private static void initValues(Context context) {
        ...
        if (isNight) {
            String preThemeString = PreferenceManager.getDefaultSharedPreferences(context).getString("colorful_pre_pref_key", null);
        ...
        public Config night(boolean night) {
            ...
            if (isNight) {
                PreferenceManager.getDefaultSharedPreferences(context).edit()
                        .putString("colorful_pre_pref_key", themeString).apply();
            } else {
                String preThemeString = PreferenceManager.getDefaultSharedPreferences(context).getString("colorful_pre_pref_key", null);
                if (preThemeString != null) {
