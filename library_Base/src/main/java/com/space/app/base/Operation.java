...
public class Operation {
    ...
    public void addParameter(DTO<?, ?> value) {
        mIntent.putExtra(SysKey.ACTIVITY_DTO_KEY, value);
    }
     ...
     * @param value 数据传输对象
     */
    public Operation addParameter(String key, Parcelable value) {
        mIntent.putExtra(key, value);
        return this;
    }
    ...
    public DTO<String, Object> getParameters() {
        ...
        DTO<String, Object> parms = (DTO<String, Object>) mContext.getIntent()
                .getExtras().getSerializable(SysKey.ACTIVITY_DTO_KEY);
        return parms;
    }
